...
///*****                                                                  *****///
//////////////////////////////////////////////////////////////////////////////////
byte enableTwitchLED[HPCOUNT]  = {1,2,2};              // Leds:   Front, Rear, Top
...
///*****                                                                  *****///
//////////////////////////////////////////////////////////////////////////////////
const byte defaultLEDTwitchCommand[3][3] = {{1,1,0},    // FRONT HP: Sequence, Color, Speed      
...
//////////////////////////////////////////////////////////////////////////////////  
 const PROGMEM uint16_t HPposBasic[2][3] = {{1500,1300,1700},        // HP Servo 1 Values for Basic Mode (Center, Min, Max)
  ...
  ///*****                                                                  *****///
  //////////////////////////////////////////////////////////////////////////////////     
  const PROGMEM uint16_t HPpos[HPCOUNT][HPPOSITIONS][2] = {{{1655,1460},   // Front HP Down
                                                            {1445,1092},   // Front HP Center
                                                            {1218,800},   // Front HP Up
                                                            {1788,1006},   // Front HP Left
                                                            {1378,800},   // Front HP Upper Left                                                          
                                                            {1844,1454},   // Front HP Lower Left
                                                            {1154,1289},   // Front HP Right 
                                                            {903,933},   // Front HP Upper Right
                                                            {1864,1332}},  // Front HP Lower Right
                                                           {{2155,1565},   // Rear HP Down
                                                            {1696,1483},   // Rear HP Center
                                                            {1080,1200},   // Rear HP Up
                                                            {1913,1187},   // Rear HP Left
                                                            {1329,1127},   // Rear HP Upper Left
                                                            {2139,1278},   // Rear HP Lower Left
                                                            {1648,1655},   // Rear HP Right
                                                            {1117,1418},   // Rear HP Upper Right
                                                            {2043,1742}},  // Rear HP Lower Right
                                                           {{1850,1689},   // Top HP Down
                                                            {1600,1170},   // Top HP Center
                                                            {1200,800},   // Top HP Up
                                                            {1817,1084},   // Top HP Left
                                                            {1480,885},   // Top HP Upper Left
                                                            {2089,1460},   // Top HP Lower Left
                                                            {1439,1259},   // Top HP Right
                                                            {1165,864},   // Top HP Upper Right
                                                            {1580,1693}}}; // Top HP Lower right
...
///*****                                                                   *****///
///////////////////////////////////////////////////////////////////////////////////
const int offcolor[HPCOUNT] = {4,9,5};      // {Front, Rear , Top}   Off (Default) = -1
